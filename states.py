...
def is_grounded(sprite1, sprite2): #TODO:can't check without having access to loop
...
def is_jumping(jump): #TODO:can't properly track pos_y without it being called under gravity code, may need it in other places
...
def jump_apex(apex, pos_y): #TODO:can't properly track pos_y without it being called under gravity code, may need it in other places
    """
    tracks if the position of the player is equal to the given apex of the jump

    Args:
        apex: the apex, or highest point of the jump
        pos_y: the position of the player on the y axis

    Return:
        returns true if the player has reached the apex of the jump, false it not
    """
